<template>
    <div class="mb-10">
        <header class="container md:w-2/3 mx-auto flex space-x-3 py-3 items-center" v-if="headerType == 0">
            <div class="text-2xl font-bold"><RouterLink to="/" class="flex space-x-3 items-center"><img class="w-[50px] h-[50px]" src="/logo.png" alt="Logo"> <div>{{ appName }}</div></RouterLink></div>
            <div class="flex-1 flex space-x-1">
                ...
                >
                <button class="rounded-full bg-gray-200 px-3 py-1">Cari</button>
            </div>
            <nav>
